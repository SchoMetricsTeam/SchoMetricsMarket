    ...
    return (
        <div className="w-full max-w-md space-y-6 rounded-xl bg-white/80 p-8 shadow-2xl backdrop-blur-xl animate-pulse">
            ...
            <div className="space-y-4">
                ...
                <div className="mt-6 h-12 w-full rounded-lg bg-linear-to-r from-emerald-200 to-teal-200"></div>
            </div>
        </div>
    );
}
...
export default function LoginPage() {
    return (
        <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-emerald-50 via-white to-teal-50">
            ...
            <div className="absolute left-1/4 top-20 h-96 w-96 animate-pulse rounded-full bg-linear-to-br from-emerald-300/30 to-teal-400/30 blur-3xl" style={{ animationDuration: '4s' }} />
            <div className="absolute right-1/4 bottom-20 h-96 w-96 animate-pulse rounded-full bg-linear-to-tr from-teal-300/30 to-emerald-400/30 blur-3xl" style={{ animationDuration: '6s', animationDelay: '2s' }} />
            ...
            >
                ...
                >
                    <div className="group flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 shadow-lg shadow-emerald-500/10 backdrop-blur-sm transition-all duration-300 hover:shadow-emerald-500/20">
                        <div className="rounded-full bg-emerald-100 p-1.5 text-emerald-600 transition-transform duration-300 group-hover:scale-110">
                            <Shield className="h-4 w-4" />
                        </div>
                        <span className="text-sm font-medium text-slate-700">Seguro</span>
                    </div>
                    <div className="group flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 shadow-lg shadow-teal-500/10 backdrop-blur-sm transition-all duration-300 hover:shadow-teal-500/20">
                        <div className="rounded-full bg-teal-100 p-1.5 text-teal-600 transition-transform duration-300 group-hover:scale-110">
                ...
                >
                    <div className="inline-block rounded-xl bg-white/60 px-6 py-4 backdrop-blur-sm">
                        <p className="text-sm text-slate-600">
                            ...
                            <span className="font-semibold bg-linear-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                                SchoMetrics
                            </span>
