...
export default function NotFound() {
    return (
        <div className="not-found min-h-screen flex items-center justify-center p-4 bg-[#000722]">
            <div className="max-w-2xl mx-auto text-center space-y-8">
                ...
                <div className="relative">
                    <div className="w-64 h-64 mx-auto bg-linear-to-br from-schoMetricsBaseColor/40 to-sellerBaseColor/30 rounded-full flex items-center justify-center">
                        <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link href="/" className="py-2 px-4 flex gap-2 justify-center items-center rounded-md bg-schoMetricsBaseColor/80 text-white hover:bg-schoMetricsBaseColor cursor-pointer">
                ...
                <div className="pt-8 border-t border-border">
                    <p className="text-slate-300">
                        <span className="font-semibold text-schoMetricsBaseColor">SchoMetrics</span> - Promoviendo una sostenibilidad ecológica y económica en México.
                    </p>
                    <div className="flex justify-center space-x-4 mt-4">
                        <div className="w-8 h-8 bg-schoMetricsBaseColor/10 rounded-full flex items-center justify-center hover:bg-schoMetricsBaseColor/20 transition-colors animate-bounce">
