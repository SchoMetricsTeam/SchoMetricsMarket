...
export default function AdminProfilePage() {
    ...
    if (!profile) {
        return (
            <div className="m-5 flex h-screen flex-col items-center justify-center gap-8 sm:m-10 bg-black">
    ...
    return (
        <div className="bg-black min-h-screen">
            ...
            <div className="m-5 flex flex-col gap-8 sm:m-10">
                <div className="mt-16 flex flex-col gap-3 rounded-xl p-8 text-white shadow-2xl lg:mt-0">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-6 lg:justify-between xl:flex-row xl:items-start">
                    ...
                    <Card className="w-full select-none md:col-span-1 bg-zinc-900 border-zinc-800 text-white">
                        {" "}
                                ...
                                <div className="relative">
                                    ...
                                    {isEditing && ( // Mostrar botón de cámara solo en modo edición
                                        <Button
                                            variant="outline"
                                            size="icon"
                                            className="absolute bottom-0 right-0 rounded-full bg-white border-none"
                    ...
                    <Card className="md:col-span w-full bg-zinc-900 border-zinc-800 text-white">
                        {" "}
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab}>
                            <CardHeader>
                                <div className="flex flex-col items-center justify-between gap-2 pb-2">
                                    ...
                                    {activeTab === "info" && !isEditing && (
                                        <Button
                                            ...
                                            disabled={isSubmitting}
                                            className="bg-schoMetricsBaseColor hover:bg-schoMetricsBaseColor/80 text-white hover:text-white cursor-pointer"
                                        >
                                    ...
                                    {activeTab === "info" && isEditing && (
                                        <div className="flex gap-2">
                                            <Button
                                                ...
                                                disabled={isSubmitting}
                                                className="text-schoMetricsBaseColor hover:text-schoMetricsBaseColor/80 cursor-pointer"
                                            >
                                ...
                                <TabsList className="grid w-max grid-cols-2" id="profile_tabs">
                                    <TabsTrigger className="cursor-pointer" value="info">Información</TabsTrigger>
                                    <TabsTrigger className="cursor-pointer" value="security">Seguridad</TabsTrigger>
                                </TabsList>
                            </CardHeader>
                            <CardContent>
