...
export default function SellerProfilePage() {
    ...
    const [profile, setProfile] = useState<SellerUserProfileData | null>(null); // Initialize as null
    ...
    const fetchProfileData = async () => {
        ...
        try {
            ...
            const data: SellerUserProfileData = await response.json();
            setProfile(data);
            setFormData({
                name: data.name || "",
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const updatedProfile: SellerUserProfileData = await response.json();
    ...
    return (
        <div>
            <SellerNavigation />
            {AvatarInput()}
            <div className="m-5 flex flex-col gap-8 sm:m-10 relative">
                <div className="mb-10">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-sellerBaseColor/5 rounded-lg border border-sellerBaseColor/30">
                            <User className="h-6 w-6 text-sellerBaseColor animate-bounce" />
                        </div>
                ...
                <div className="flex w-full flex-col items-center justify-center gap-6 lg:justify-between xl:flex-row xl:items-start">
                    ...
                    <Card className="w-full select-none md:col-span-1 bg-indigo-50 border-indigo-100 shadow-md shadow-indigo-300">
                        {" "}
                            ...
                            <div className="flex flex-col items-center">
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        />
                                        <AvatarFallback className="bg-indigo-600 text-3xl uppercase text-white font-bold border-2 border-white">
                                ...
                                {!isEditing && (
                                    <p className="mt-4 px-5 text-center text-xs text-indigo-400 lg:px-10">
                                        Para cambiar la foto de Perfil da clic en "Editar
                                        Información" y luego en "Guardar".
                                    </p>
                                )}
                                <CardTitle className="mt-4 text-center text-xl uppercase text-indigo-700 font-bold">
                                    {profile.name}
                                </CardTitle>
                                <div className="w-full overflow-auto text-center text-indigo-600">
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-1">
                                <div className="mt-10 flex items-center gap-2 text-sm">
                                    ...
                                    <span className="text-indigo-600 font-semibold">{formatDate(profile.createdAt, false)}</span>
                                </div>
                                ...
                                <div className="flex items-center gap-2 text-sm">
                                    ...
                                    <span className="text-indigo-600 font-semibold">{profile.identifier}</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    <Card className="md:col-span w-full bg-indigo-50 border-indigo-100 shadow-md shadow-indigo-300">
                        {" "}
                            ...
                            <CardHeader>
                                <div className="flex flex-col items-center justify-between gap-2 pb-2">
                                    ...
                                    <CardDescription className="text-center text-red-500 flex gap-2 justify-center items-center font-semibold">
                                        ...
                                        Por favor, manten toda la información de tu Perfil completa antes publicar Materiales Reciclables.
                                    </CardDescription>
                                    <CardDescription className="text-center text-indigo-400 font-normal">
                                        El <b>(Nombre, CCT y RFC)</b> son datos que requieren validación previa, por lo tanto no se permite modificarlos, si necesitas actualizar la información, comunícate a <b>soporte@schometrics.com</b>
                                    </CardDescription>
                                    {activeTab === "info" && !isEditing && (
                                        <Button
                                            ...
                                            disabled={isSubmitting}
                                            className="mt-4 bg-indigo-500 hover:bg-indigo-600 border-none text-white hover:text-white cursor-pointer"
                                        >
                                    ...
                                    {activeTab === "info" && isEditing && (
                                        <div className="flex gap-2">
                                            ...
                                            <Button
                                                size="sm"
                                                className="bg-indigo-600 hover:bg-indigo-500 border-none text-white hover:text-white cursor-pointer"
                                                onClick={handleSave}
                                                disabled={isSubmitting}
                                            >
                                                {isSubmitting ? (
                                ...
                                <TabsList className="grid w-max grid-cols-2 bg-indigo-300" id="profile_tabs">
                                    <TabsTrigger className="cursor-pointer data-[state=active]:text-indigo-700 not-[state=active]:text-white" value="info">Información</TabsTrigger>
                                    <TabsTrigger className="cursor-pointer data-[state=active]:text-indigo-700 not-[state=active]:text-white" value="security">Seguridad</TabsTrigger>
                                </TabsList>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    {isEditing ? (
                                        <>
                                            <div className="grid gap-2">
                                                <Label htmlFor="email" className="text-sm font-semibold text-indigo-400">
                                            ...
                                            <div className="grid gap-2">
                                                <Label htmlFor="phone" className="text-sm font-semibold text-indigo-400">
                                                    Teléfono
                                                </Label>
                                                <Input
                                                    id="phone"
                                            ...
                                            <div className="grid gap-2">
                                                <Label htmlFor="postalCode" className="text-sm font-semibold text-indigo-400">
                                                    Código Postal
                                                </Label>
                                                <Input
                                                    id="postalCode"
                                                    ...
                                                    disabled={isSubmitting}
                                                    required
                                                    className="w-max bg-white border-indigo-300"
                                                    placeholder="Código Postal"

                                                />
                                            </div>
                                            <div className="grid gap-2">
                                                <Label htmlFor="address" className="text-sm font-semibold text-indigo-400">
                                                    Dirección
                                                </Label>
                                                <Input
                                                    id="address"
                                            ...
                                            <div className="grid gap-4 md:grid-cols-2">
                                                <div className="grid gap-2">
                                                    <Label htmlFor="city" className="text-sm font-semibold text-indigo-400">
                                                        Ciudad
                                                    </Label>
                                                    <Input
                                                        id="city"
                                            ...
                                            <div className="space-y-2 w-max">
                                                <Label htmlFor="state" className="text-sm font-semibold text-indigo-400">
                                                    ...
                                                    <SelectContent>
                                                        <SelectGroup>
                                                            ...
                                                            {MEXICAN_STATES.map((stateName) => (
                                                                <SelectItem key={stateName} value={stateName} className="cursor-pointer hover:bg-slate-100">
                                                                    {stateName}
                                                                </SelectItem>
                                                            ))}
                                                        </SelectGroup>
                                        ...
                                        <>
                                            <div className="space-y-1">
                                                <h3 className="flex items-center gap-2 font-medium text-zinc-400">
                                                    <User className="h-4 w-4 text-muted-foreground" />
                                                    Nombre completo
                                                </h3>
                                                <p className="uppercase text-indigo-500 font-semibold">{profile.name}</p>
                                            </div>

                                            {profile.profile?.email && (
                                                <div className="space-y-1">
                                                    <h3 className="font-medium text-zinc-400">Correo Electrónico</h3>
                                                    <p className="overflow-auto text-indigo-500 font-semibold">
                                                        {profile.profile.email}
                                                    </p>
                                                </div>
                                            )}
                                            <div className="space-y-1">
                                                <h3 className="font-medium text-zinc-400">Número de Teléfono de la Institución</h3>
                                                <p className="overflow-auto text-indigo-500 font-semibold">
                                            ...
                                            </div>
                                            {
                                                profile.userType === "SELLER" ? (
                                                    <div className="flex flex-col gap-2">
                                                        <div className="space-y-1">
                                                            <h3 className="font-medium text-zinc-400">Clave de Centro de Trabajo (CCT)</h3>
                                                            <p className="text-indigo-500 font-semibold">
                                                                {profile.profile?.cct}
                                                            </p>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <h3 className="font-medium text-zinc-400">Registro Federal de Contribuyentes (RFC)</h3>
                                                            <p className="text-indigo-500 font-semibold">
                                                                {profile.profile?.rfc}
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div className="space-y-1">
                                                        <h3 className="font-medium text-zinc-400">Clave de Registro Federal (RFC)</h3>
                                                        <p className="text-indigo-500 font-semibold">
                                                            {profile.profile?.rfc}
                                                        </p>
                                                    </div>
                                            ...
                                            <div className="pt-2">
                                                <h3 className="mb-2 font-medium text-zinc-400">Ciudad y Estado</h3>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    {
                                            ...
                                            <div className="space-y-1">
                                                <h3 className="font-medium text-zinc-400">Código Postal</h3>
                                                <p className="text-indigo-500 font-semibold">
                                                    {profile.profile?.postalCode}
                                                </p>
                                            </div>
                                            <div className="pt-2">
                                                <h3 className="mb-2 font-medium text-zinc-400">Dirección</h3>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <div className="flex items-start gap-2">
                                                        <div className="text-indigo-500 font-semibold">
