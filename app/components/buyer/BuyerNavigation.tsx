...
import { User, LogOut, UserCircle, Box, MailWarning, ArrowRightCircle } from "lucide-react"
...
export function BuyerNavigation() {
    ...
    return (
        <nav className="bg-[#002130] z-50 relative">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent className="w-56" align="end" forceMount>
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link href={`/comprador/materiales-disponibles/`} className="text-teal-500 font-semibold">
