...
export const RecyclableMaterialContentImages = ({
  ...
  return (
    <div className="mt-2">
      <div className="relative flex justify-center w-max items-center gap-2">
        ...
        {selectedMedia && (
          ...
          >
            ...
            <Button
              variant="outline"
              onClick={handleCloseModal}
              className="absolute top-0 mt-3 border-none bg-schoMetricsBaseColor text-white cursor-pointer"
            >
