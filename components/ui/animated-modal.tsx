...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-2 py-2 rounded-md text-black text-center relative overflow-hidden cursor-pointer",
        className
      )}
...
export const ModalContent = ({
  ...
  return (
    <div className={cn("flex flex-col flex-1 p-8 md:p-10 overflow-scroll", className)}>
      {children}
    </div>
  );
};
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-4 group bg-red-700 rounded-md cursor-pointer p-1"
    >
      <svg
